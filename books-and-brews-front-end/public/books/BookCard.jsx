        ...
        <div className="rounded-lg transition-shadow duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center sm:h-72 sm:justify-center gap-4">
                <div className="sm:h-72 sm:flex-shrink-0 ">
                    ...
                    <img
                        src={`/books/${book.description.image || "/nocover"}.png`} //setting the image to imageId or if none then default image
                ...
                <div>
                    <h3 className="text-xl font-semibold hover:text-orange-900 mb-3">
                        {book.title}
                    </h3>
