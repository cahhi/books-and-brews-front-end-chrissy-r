...
const AuthorList = () => {
    ...
    const updateAuthor = async (id, updateAuthorData) => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/api/authors/update/${id}`,
            {
                method: 'PUT',
                headers: {
    ...
    let authorRowsJSX = currentAuthors.map(author => {
        ...
        return (
            <tr key={author.id}>
              ...
              <td className="save">
                <span onClick={() => updateAuthor(author.id, {
                    firstName: author.firstName,
                    lastName: author.lastName
                })}>
                        <i 
                        ...
                        ><div className="flex items-center justify-center"><RiSave3Line /> </div></i>
                    </span>
              </td>
                <td className="delete">
                    <span onClick={() => handleDelete(author.id)}>
                        ...
                        ><div className="flex items-center justify-center"><FcFullTrash /></div></i>
                    </span>
