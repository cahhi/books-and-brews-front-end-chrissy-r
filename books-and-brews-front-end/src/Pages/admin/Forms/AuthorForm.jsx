...
const AuthorForm = () => {
    ...
    const handleChange = e => { //updating the state when admin user types in the input fields
    ...
    const handleSubmit = e => {
        ...
        if (!authorDTO.isValid()) { //using validation to make sure that the form is completed
            setHasErrors(true);
        } {
    ...
    return (
        ...
        <main>
            ...
            <form>
                ...
                <button type="submit" onClick={handleSubmit}>Add Author</button> {/* When users click on the submit - it is sending to the /api/authors/add */}
            </form>
        </main>
    )
};
